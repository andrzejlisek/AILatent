...
export class Environment {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Environment.prototype);
        obj.__wbg_ptr = ptr;
        EnvironmentFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
    ...
    callback(param) {
        ...
        wasm.environment_callback(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} op
     * @param {number} stage
     ...
     * @returns {string}
     */
    data(op, stage, param1, param2, param3) {
        let deferred5_0;
        let deferred5_1;
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            ...
            const len0 = WASM_VECTOR_LEN;
            _assertNum(stage);
            const ptr1 = passStringToWasm0(param1, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(param2, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('AILatent_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
